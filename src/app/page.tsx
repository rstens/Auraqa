  ...
  return (
    <div className="flex flex-col">
      ...
      <section
        ...
        className="bg-gradient-to-b from-slate-50 to-white px-4 py-20 text-center dark:from-slate-950 dark:to-slate-900 sm:py-28"
      >
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
          Knowledge articles, community forums, and a testing tools directory — all in one place.
          Powered by AI to help you find answers faster.
        </p>
      ...
      <section
        ...
        className="border-t border-slate-200 bg-slate-50 px-4 py-16 dark:border-slate-700 dark:bg-slate-900"
      >
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white">AI-Powered Features</h2>
          <p className="mt-4 text-slate-600 dark:text-slate-400">
            Claude AI helps you work smarter — from summarizing articles and suggesting answers to
            expanding your search queries and classifying content with relevant tags.
          </p>
          <div className="mt-8 grid gap-4 text-left sm:grid-cols-2">
            <AIFeature
              title="Smart Search"
              description="Natural language queries expanded into precise search terms"
            />
            <AIFeature
              title="Article Summaries"
              description="2-3 sentence summaries generated for every published article"
            />
            <AIFeature
              title="Answer Suggestions"
              description="AI-suggested answers for unanswered community questions"
            />
            <AIFeature
              title="Tag Classification"
              description="Content automatically classified with relevant testing tags"
            />
          </div>
        </div>
      </section>
