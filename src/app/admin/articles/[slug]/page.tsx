...
export default async function AdminArticleDetailPage({
  ...
  return (
    <div data-testid="admin-article-detail">
      <Link
        href="/admin/articles"
        data-testid="back-to-admin-articles"
      ...
      <div className="mt-4">
        ...
        <div className="mt-2 text-sm text-slate-500 dark:text-slate-400">
          by {article.authorName ?? article.authorUsername ?? "Anonymous"} &middot; Created{" "}
      ...
      {article.aiSummary && (
        <div
          data-testid="article-ai-summary"
      ...
      {article.summary && (
        <div
          ...
          className="mt-4 rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800"
        >
