...
export const verificationTokens = pgTable(
  ...
  (table) => [unique("verification_tokens_identifier_token").on(table.identifier, table.token)],
);
...
export const articleTags = pgTable(
  ...
  (table) => [unique("article_tags_pk").on(table.articleId, table.tagId)],
);
...
export const forumThreadTags = pgTable(
  ...
  (table) => [unique("forum_thread_tags_pk").on(table.threadId, table.tagId)],
);
...
export const toolTags = pgTable(
  ...
  (table) => [unique("tool_tags_pk").on(table.toolId, table.tagId)],
);
